import unittest
from activities import eat, nap, laugh, is_funny
...
class ActivityTests(unittest.TestCase):
    ...
    def test_eat_healthy_boolean(self):
        ...
        with self.assertRaises(ValueError): eat("pizza", is_healthy="who cares?")
    ...
    def test_nap_str(self):
        """naps should be int"""
        with self.assertRaises(ValueError): nap("who")
